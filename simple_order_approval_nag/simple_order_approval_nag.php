		...
		echo wp_kses_post(
			sprintf(
				...
				sprintf(
					...
					esc_url( 'https://nakedcatplugins.com/product/simple-woocommerce-order-approval/?utm_source=' . rawurlencode( esc_url( home_url( '/' ) ) ) . '&utm_medium=banner&utm_campaign=shop_as_client_plugin' )
				),
				'</a>'
			)
		);
